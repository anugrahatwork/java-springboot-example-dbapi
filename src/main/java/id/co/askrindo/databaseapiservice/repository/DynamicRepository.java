package id.co.askrindo.databaseapiservice.repository;


import id.co.askrindo.databaseapiservice.model.dto.ColumnInfo;
...
public class DynamicRepository {
    ...
    public List<ColumnInfo> getAllColumnName(String tableName) {
        try (Connection connection = dataSource.getConnection()) {
